...
var APP = {
	...
	Player: function () {
		...
		var camera, cameraPulley, scene, renderer;
		...
		this.registerAnimation = function(eventCallBack){
			register(events.update, eventCallBack);
		};
		...
		this.load = function ( json ) {
			...
			this.setImportedScene( loader.parse( json.scene ) );
		...
		this.setCamera = function ( value ) {
			...
			this.camera = value;
			camera = value;
			camera.position.set( -1.8, 12, -1);         // place camera on initial position i.e. top
		...
		this.setImportedScene = function ( importedScene ) {
		...
		function register(array, eventCallback){
